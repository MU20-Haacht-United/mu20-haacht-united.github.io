...
export const dutyAssignments: DutyAssignment[] = [
  ...
  { datum: '2025-11-02', tegenstander: 'Grasheide', thuis: true, bar: [3,5], fruit: 4, was: 4, gespeeld: false },
  { datum: '2025-11-09', tegenstander: 'Laakdal', thuis: true, bar: [4,6], fruit: 8, was: 8, gespeeld: false },
